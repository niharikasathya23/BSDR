...
def main(cfg, gpu, save_dir):
    ...
    iters_per_epoch = max(1, len(trainset) // train_cfg["BATCH_SIZE"])
    ...
    for epoch in range(epochs):
        ...
        num_samples = min(num_batches, 5)  # Ensure you do not sample more than available
        random_batch_indices = random.sample(range(0, num_batches), num_samples)
